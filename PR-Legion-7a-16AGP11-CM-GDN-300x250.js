...
lib.ssMetadata = [
		{name:"PR_Legion_7a_16AGP11_CM_GDN_300x250_atlas_1", frames: [[302,756,50,50],[0,0,300,250],[0,252,300,250],[0,504,300,250],[0,756,300,250],[302,0,300,250],[302,252,300,250],[302,504,300,250]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Legion_7a_16AGP11_CM_GDN_300x250_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRLegion7a16AGP11CMGDN300x250 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(361).to({_off:false},0).to({x:10.35,y:11},12).wait(37));
...
// library properties:
lib.properties = {
	id: '7DD6EC78AC287E4388DAECD1C3332E7E',
	width: 300,
	height: 250,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Legion_7a_16AGP11_CM_GDN_300x250_atlas_1.png", id:"PR_Legion_7a_16AGP11_CM_GDN_300x250_atlas_1"}
	],
	preloads: []
};
...
an.compositions['7DD6EC78AC287E4388DAECD1C3332E7E'] = {
